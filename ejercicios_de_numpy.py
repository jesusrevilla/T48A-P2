...
Original file is located at
    https://colab.research.google.com/drive/1XXZRbrF5PJyQnk2kL1BQ551YxaCxx9WV
...
x = reshape_10x10x10(np.arange(1000))
print(x)
...
def temp_data(temps):
  ...
  print(np.count_nonzero(temps[temps < 15]))

daily_temperatures = np.array([20,25,34,45,12,45,32,22,28,25,45])
temp_data(daily_temperatures)
...
result = rainfall_data(np.array([[10, 20, 30], [40, 50, 60], [70, 80, 90]]))
print(result)
...
image_thresholding(np.array([[155, 20, 30], [40, 50, 60], [70, 80, 128]]))
