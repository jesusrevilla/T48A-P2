...
Original file is located at
    https://colab.research.google.com/drive/1DR9iEuc_ODWkp7bCHJLC0LiIV2hhSJW4
...
reshape_10x10(np.random.randint(1, 101, 100))
...
reshape_10x10x10(np.random.randint(1, 1001, 1000))
...
reshape_10x10x10x10(np.random.randint(1, 10001, 10000))
