...
Original file is located at
    https://colab.research.google.com/drive/1EpZl9_wojlSoZDWpY0ebp5F8Br6eQI3a
...
def squares():
  ...
  '''
  square = np.array([x**2 for x in range(1, 11)])
  return square
...
def cubes():
  ...
  '''
  cube = np.array([x**3 for x in range(1, 11)])
  return cube
...
def temp_data(temps):
  ...
  below_15 = temps[temps < 15]
  print(f'Temperaturas mayores a 25 grados: {above_25}')
  print(f'Número de días con temperaturas menores a 15 grados: {len(below_15)}')
