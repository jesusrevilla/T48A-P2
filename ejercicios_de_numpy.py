# -*- coding: utf-8 -*-
"""Copia de Ejercicios173577.ipynb

Automatically generated by Colab.

Original file is located at
    https://colab.research.google.com/drive/1r8QK6JY6uB7bTLwx7dPr6btFvaj6zSPM
...
#Aneth Alejandra Lopez Cerda 173577
import numpy as np
...
def first_5(arr):
  ...
  return arr[:5]
first_5(np.random.randint(0, 101, 10))
...
def last_3(arr):
  ...
  assert arr.size == 10, 'El arreglo debe tener 10 elementos'
  return arr[-3:]
last_3(np.random.randint(0, 101, 10))
...
def indices_2_4_6(arr):
  ...
  assert arr.size == 10, 'El arreglo debe tener 10 elementos'
  return arr[[2, 4, 6]]
indices_2_4_6(np.random.randint(0, 101, 10))
...
def greater_50(arr):
  ...
  assert arr.size == 10, 'El arreglo debe tener 10 elementos'
  return arr[arr > 50]
greater_50(np.random.randint(0, 101, 10))
...
def less_7(arr):
  ...
  return arr[arr <= 7]
less_7(np.random.randint(0, 11, 10))
...
reshape_2x3x4(np.random.randint(0, 101, 24))
...
reshape_10x10(np.random.randint(0, 101, 100))
...
reshape_10x10x10(np.random.randint(0, 101, 1000))
...
reshape_10x10x10x10(np.random.randint(0, 101, 10000))
...
def rainfall_data(rainfall):
  ...
  print('Índices de las ciudades con más de 100 mm de lluvia: [0 1 1 2]')
